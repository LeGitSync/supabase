...
- **Missing cleanup on component teardown**: Single-page applications that don't unsubscribe when components are removed can accumulate connections over time
