    ...
    <div className="space-y-2">
      ...
      <div className="space-y-2 text-sm text-foreground-light">
        ...
        <ul className="list-disc pl-5 space-y-1">
          ...
          <li>
            <strong>Collapsible platform pages</strong> - Auth, Storage, Edge Functions, and Realtime
            are collapsible items with their sub-pages nested inside.
          </li>
          <li>
          ...
          <li>
            <strong>No project header bar</strong> - Project and organization context is displayed in
            the sidebar header.
          </li>
        </ul>
      </div>
