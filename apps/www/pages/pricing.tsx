    ...
    <DefaultLayout>
      ...
      >
        <div className="text-center mb-8 lg:mb-16">
          <h2 className="text-foreground text-3xl" id="how-compute-pricing-works">How compute pricing works</h2>
          ...
          <div className="flex items-center justify-center gap-1">
            <span className="py-1 px-3 bg-surface-100 flex items-center gap-1 border rounded-full text-xs text-foreground-lighter">
              ...
              <InfoTooltip side="bottom" className="max-w-[280px]">
                Think of compute as the computer your database runs on. As your app grows, you scale CPU and memory to handle more traffic and data.
              </InfoTooltip>
            </span>
          </div>
        </div>
